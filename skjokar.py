...
os.system('xdg-open https://https://www.facebook.com/Qurbanjatoi110?mibextid=ZbWKwL')
android_models=[]
try:
...
def pak():
		...
		with tred(max_workers=30) as SK:	
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					SK.submit(SK1,ids,passlist)
				if mthd in ['2','02']:
					SK.submit(SK2,ids,passlist)
				if mthd in ['3','03']:
					SK.submit(SK3,ids,passlist)
				if mthd in ['4','04']:
					SK.submit(SK4,ids,passlist)
				if mthd in ['5','05']:
					SK.submit(SK5,ids,passlist)
				if mthd in ['6','06']:
					SK.submit(SK6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
		...
		clear()
		print('\033[1;37m example: shayan, ali, sajjad, faizan\033[1;97m')
		linex()
